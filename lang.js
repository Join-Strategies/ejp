...
(function () {
  ...
  var es = {
    ...
    'index-cpt-strong':      '¿Completando tu programa CPT?',
    ...
    'index-faq-a7':          'Los proveedores de salud asociados pueden enviar vacantes directamente a EJP para conectarse con candidatos calificados y motivados. Los socios también recibirán apoyo de un reclutador dedicado de EJP que trabajará con los socios para comprender sus necesidades de contratación y entregar los candidatos adecuados.',
    ...
    'emp-svc-partner-p':     'Cada instalación asociada obtiene un reclutador dedicado de EJP que trabaja directamente con sus equipos de recursos humanos para apoyar las necesidades continuas de personal y desarrollo de la fuerza laboral.',
    'emp-how-h2':            'Cómo Trabajar con Nosotros',
    'emp-cpt-grad-h2':       '¿Está interesado en contratar graduados de CPT?',
    'emp-cpt-grad-p':        'Para contratar graduados de CPT, su organización primero debe convertirse en un empleador atestiguado. Averigüe si califica y cómo enviar su formulario de atestación.',
    'emp-cpt-grad-btn':      'Saber Más →',
    ...
    'emp-partner-p':         'Recibe acceso a la cartera de graduados recientes de CPT de EJP.',
