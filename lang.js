...
(function () {
  ...
  var es = {
    ...
    'index-services-intro':  'Ya sea que estés buscando tu próximo rol o tratando de cubrir uno, EJP construye una fuente de reclutamiento centralizando puestos disponibles y reuniendo candidatos calificados.',
    'index-svc-1-h3':        'Centralizar Empleos de Salud',
    'index-svc-1-p':         'EJP reúne ofertas de empleo de cientos de instalaciones asociadas en un portal fácil de usar para que puedas aplicar en un solo lugar. Ten en cuenta que EJP no tiene información sobre los tiempos de respuesta de los empleadores.',
    ...
    // ── job-seekers.html ──────────────────────────────────────────
    'js-hero-h1':            'Únete al Grupo de Candidatos',
    ...
    'js-wizard-intro':       'Déjanos saber si eres parte del Programa de Capacitación en Carreras Profesionales (CPT) para poder dirigirte mejor.',
    ...
    'js-benefits-intro':       'Más de 450,000 miembros fuertes, los trabajadores de 1199 negocian juntos contratos sólidos que garantizan un salario justo, buenos beneficios y oportunidades educativas mientras lideran la lucha por apoyar a los trabajadores en todo Estados Unidos.',
