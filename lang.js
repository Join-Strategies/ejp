...
(function () {
  ...
  var es = {
    ...
    'index-hero-deck':       'El Centro de Empleo y Ubicación Laboral conecta a los buscadores de empleo con empleadores del sector salud en toda Nueva York a través de nuestra red de instalaciones asociadas.',
    'index-hero-btn-primary':   'Estoy Buscando Trabajo →',
    ...
    'index-services-intro':  'Ya sea que estés buscando tu próximo rol o tratando de cubrir uno, EJP te conecta con oportunidades en el sector salud en Nueva York.',
    'index-svc-1-h3':        'Buscar Empleos',
    'index-svc-1-p':         'Explora puestos disponibles en instalaciones de salud asociadas en toda Nueva York. EJP mantiene un tablero de empleos activo que conecta candidatos calificados con empleadores que buscan contratar.',
    'index-svc-2-h3':        'Construyendo una Fuerza Laboral de Salud Sólida',
    'index-svc-2-p':         'Trabajamos con hospitales, hogares de ancianos y sistemas de salud para entender sus necesidades de personal y conectarlos con candidatos listos para contribuir.',
    'index-svc-3-h3':        'Qué Esperar',
    'index-svc-3-p':         'EJP es parte del Fondo de Capacitación y Empleo de 1199SEIU. Cuando aplicas a través de nuestra red, tu perfil entra a un grupo revisado por reclutadores a medida que se abren posiciones. Esto no es una garantía de colocación — es acceso a una red que trabaja activamente para cubrir roles.',
    ...
    'index-faq-a1':          'El Centro de Empleo y Ubicación Laboral es un departamento del Fondo de Capacitación y Empleo de 1199SEIU. Conectamos a buscadores de empleo con empleadores del sector salud en toda Nueva York a través de nuestra red de instalaciones asociadas.',
    'index-faq-q2':          '¿Aplicar a través de EJP me garantiza un trabajo?',
    'index-faq-a2':          'No. Cuando aplicas, tu perfil entra a un grupo de candidatos que nuestro equipo de reclutamiento revisa a medida que se abren posiciones en instalaciones asociadas. La colocación depende de las vacantes disponibles, los requisitos del empleador y las calificaciones del candidato. No hay un plazo garantizado para el seguimiento.',
    'index-faq-q3':          '¿Quién califica para servicios de carrera?',
    'index-faq-a3':          'Los servicios de carrera dedicados — incluyendo ayuda con currículum, asesoramiento de carrera, preparación para entrevistas y apoyo de colocación — están disponibles para participantes de CPT (Capacitación en Carreras Profesionales). Los miembros actuales del sindicato 1199 pueden acceder a apoyo de carrera a través del portal myTEF. Todos los demás buscadores de empleo pueden navegar y aplicar a puestos disponibles a través de nuestro tablero de empleos.',
    'index-faq-q4':          '¿Qué es myTEF?',
    'index-faq-a4':          'myTEF es el portal en línea para miembros actuales del sindicato 1199SEIU. A través de myTEF, los miembros pueden acceder a servicios de apoyo de carrera, solicitar asesoramiento y gestionar sus beneficios — todo proporcionado a través del departamento de Educación.',
    'index-faq-q5':          '¿Por qué trabajar en una instalación de 1199SEIU?',
    'index-faq-a5':          'Los miembros de 1199SEIU reciben beneficios que van más allá de un cheque de pago: seguro de salud de bajo costo o sin costo para ti y tu familia, aumentos anuales garantizados, seguridad de jubilación con contribuciones del empleador, oportunidades de educación y capacitación sin costo, protecciones laborales incluyendo procedimientos disciplinarios justos, y voz en tu lugar de trabajo. Una agencia puede ofrecer un salario inicial más alto — pero 1199 ofrece una carrera.',
    'index-faq-q6':          '¿Cómo publican los empleadores roles a través de EJP?',
    'index-faq-a6':          'Los proveedores de salud asociados pueden enviar vacantes directamente a EJP. Si aún no eres socio, contáctanos para conocer cómo unirte a la red. Durante el período del programa CPT, los empleadores no asociados también pueden enviar roles específicos para participantes de CPT.',
    ...
    'js-hero-p':             'Ya sea que seas nuevo en la industria o estés buscando realizar un cambio, el Centro de Empleo y Ubicación Laboral te brinda los recursos y el apoyo que necesitas para construir una carrera en salud.',
    ...
    'js-wizard-jobs-p':      'Explora puestos de salud disponibles en toda Nueva York y envía tu solicitud a empleadores en la red de 1199SEIU.',
    'js-wizard-cpt-p':       'Actualmente inscrito o completando un programa de Capacitación en Carreras Profesionales? Accede a tus servicios de carrera dedicados y crea tu perfil iCIMS.',
    ...
    'js-benefits-kicker':      'Por qué 1199SEIU',
    'js-benefits-h2':          'Más Que Solo un Trabajo',
    'js-benefits-intro':       'Una agencia puede ofrecer un salario inicial más alto — pero 1199SEIU ofrece una carrera. Cuando trabajas en una instalación de 1199, eres parte del sindicato de salud más grande del país, con beneficios que van mucho más allá de un cheque de pago.',
    'js-svc-stability-h3':     'Estabilidad Laboral',
    'js-svc-stability-p':      'Las cláusulas de no subcontratación protegen tu puesto. Los procedimientos disciplinarios justos requieren causa justa y representación sindical. Si hay despidos, tienes derechos de recontratación y opciones de transferencia.',
    'js-svc-wages-h3':         'Salarios Dignos',
    'js-svc-wages-p':          'Aumentos anuales garantizados, incrementos escalonados por experiencia, diferenciales de turno mejorados para noches, fines de semana y feriados. Pago premium por certificaciones.',
    'js-svc-ladders-h3':       'Escaleras Profesionales',
    'js-svc-ladders-p':        'Accede a programas de educación sin costo incluyendo clases universitarias, reembolso de matrícula, unidades de educación continua, alfabetización informática y capacitación en habilidades técnicas. Tiempo libre pagado para clases.',
    'js-svc-protections-h3':   'Protecciones para Trabajadores',
    'js-svc-protections-p':    'Seguro de salud de bajo costo o sin costo para ti y tu familia — dental, visión y recetas incluidos. Planes de jubilación con contribuciones significativas del empleador. Un sindicato que lucha por dotación adecuada y condiciones de trabajo seguras.',
    ...
    // ── cpt.html ─────────────────────────────────────────────────
    'cpt-hero-h1':           '¿Ya creaste tu cuenta de iCIMS?',
    'cpt-hero-p':            'Como participante de CPT, tienes acceso a servicios de carrera dedicados incluyendo asistencia con currículum, asesoramiento de carrera, preparación para entrevistas y apoyo de colocación laboral. Tu primer paso es crear tu perfil de iCIMS para que nuestro equipo de reclutamiento pueda conectarte con oportunidades en instalaciones de salud asociadas en toda Nueva York.',
    ...
    'cpt-expect-h2':         'Cómo Funcionan los Servicios de Carrera',
    'cpt-expect-p':          'Los servicios de carrera están disponibles para todos los participantes de CPT — antes y después de la graduación. Cuando se abre una vacante en una instalación asociada, nuestro equipo de reclutamiento revisa el grupo de candidatos para la mejor coincidencia. La colocación depende de las vacantes disponibles y los requisitos del empleador.',
