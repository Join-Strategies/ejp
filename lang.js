...
(function () {
  ...
  var es = {
    ...
    'index-hero-deck':       'El Centro de Empleo y Ubicación Laboral se dedica a ayudar a los buscadores de empleo a construir carreras duraderas y a los empleadores a formar equipos más fuertes a través de servicios de carrera personalizados y asociaciones directas con empleadores.',
    'index-hero-btn-primary':   'Explorar Servicios de Carrera →',
    'index-hero-btn-secondary': 'Acceder a Recursos para Empleadores',
    ...
    'index-services-intro':  'Ya sea que estés buscando tu próximo rol o tratando de cubrir uno, EJP tiene los recursos y la orientación para ayudarte a llegar allí.',
    'index-svc-1-h3':        'Servicios y Apoyo de Carrera',
    'index-svc-1-p':         'Ya sea que estés comenzando o realizando un cambio, EJP ofrece apoyo de carrera y capacitación en habilidades para ayudarte a asegurar un puesto.',
    'index-svc-1-link':      'Explorar Servicios de Carrera →',
    ...
    'js-wizard-jobs-p':      'Explora puestos de salud disponibles y envía tu currículum a empleadores en toda Nueva York. Tenga en cuenta que EJP no tiene información sobre los tiempos de respuesta de los empleadores.',
    'js-wizard-support-h3':  'Busco Apoyo de Carrera',
    'js-wizard-support-p':   'Desde ayuda con el currículum hasta preparación para entrevistas, los servicios de carrera de EJP te brindan las herramientas y la confianza para competir por los puestos que realmente deseas.',
